      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4 text-sm">
          <button 
            ...
            className="flex items-center gap-2 text-gray-400 hover:text-white hover:bg-white/10 px-2 py-1 rounded transition-colors"
          >
        ...
        <div className="flex items-center gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-300 font-medium">{currentCase.qa.completeness}%</span>
          </div>
